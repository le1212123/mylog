...
<div class="log">
    <div class="am-g">
        <div class="am-u-lg-3 am-u-md-6 am-u-sm-8 am-u-sm-centered log-content">
            ...
            @endif
            <h1 class="log-title am-animation-slide-top">找回密码</h1>
            <br>
            <form class="am-form" id="log-form" action="/admin/res" method="post">
                ...
                <div class="am-input-group am-animation-slide-left log-animation-delay">
                    <input type="text" name="secret" class="am-form-field am-radius log-input" data-validation-message="请输入令牌" placeholder="滚学球令牌" required>
                    <span class="am-input-group-label log-icon am-radius"><i class="am-icon-lock am-icon-sm am-icon-fw"></i></span>
                </div>
                <br>
                <div class="am-input-group am-animation-slide-left log-animation-delay-a">
                    <input type="password" name="pwd" id="log-password" minlength="6" class="am-form-field am-radius log-input" placeholder="新密码" required>
                    <span class="am-input-group-label log-icon am-radius"><i class="am-icon-lock am-icon-sm am-icon-fw"></i></span>
                </div>
                <br>
                <button type="submit" class="am-btn am-btn-primary am-btn-block am-btn-lg am-radius am-animation-slide-bottom log-animation-delay-b">修改</button>
            </form>
        </div>
    </div>
